...
#define pr_fatal(fmt, ...) pr_log(false, LOG_FATAL, pr_fmt(fmt), ##__VA_ARGS__)

#define pr_err(fmt, ...) pr_log(false, LOG_ERROR, pr_fmt(fmt), ##__VA_ARGS__)

#define pr_warning(fmt, ...)                                                   \
  pr_log(false, LOG_WARNING, pr_fmt(fmt), ##__VA_ARGS__)

#define pr_info(fmt, ...) pr_log(false, LOG_INFO, pr_fmt(fmt), ##__VA_ARGS__)

#define pr_debug(fmt, ...) pr_log(false, LOG_DEBUG, pr_fmt(fmt), ##__VA_ARGS__)
...
void set_log_enabled(bool enable);
